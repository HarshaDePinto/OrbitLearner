                            ...
                            <tbody>
                                ...
                                <th class="text-center">
                                 ...
                                 <td>
                                  ...
                                  <td><a href="{{route('teacher_c_tutorial_s',$tut->id)}}" class="btn btn-primary" >Detail</a></td>
                                </tr>
                                @endforeach
        ...
        <div class="row">
          <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                  <form method="POST" enctype="multipart/form-data" action="{{route('teacher_c_tutorial_c')}}">
                      @csrf
