          ...
          <div class="card-body">
            <div class="author-box-center">
                ...
                <img alt="image" src="{{ asset('storage/app/'.$student->image) }}" class="rounded-circle author-box-picture">  
                 @else
                 @if ($student->gender==1)
                 <img alt="image" src="{{ asset('public/back/assets/img/student.jpg') }}" class="rounded-circle author-box-picture">
                 @endif
                 @if ($student->gender==2)
                 <img alt="image" src="{{ asset('public/back/assets/img/studentf.jpg') }}" class="rounded-circle author-box-picture">
                 @endif
              ...
              <div class="author-box-job">{{$student->role->name}}</div>
            </div>
