...
@section('styles')
<title>{{$student->title}} {{$student->f_name}} {{$student->l_name}}</title>
            ...
            <div class="collapse" id="studentDelete">
                ...
                <div class="alert alert-danger">
                  All the content including personal details and related images will delete permanently from the system and will not be able to recover again. <b>Are you sure?</b>
                    ...
                    <form method="POST" class="needs-validation" enctype="multipart/form-data" action="{{route('admin_student_delete')}}">
                      @csrf
                ...
                <div class="alert alert-warning">
                  This student already conected with courses. Please remove student from the courses to delete! 
                </div>
                @endif
          ...
          <div class="padding-20">
            ...
            <div class="tab-content tab-bordered" id="myTab3Content">
              <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                <form method="POST" enctype="multipart/form-data" action="{{route('admin_profile_update',$student->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="card-header">
                      <h4>Edit Profile</h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-5 col-12">
                            ...
                            <input type="text" class="form-control" name="b_day" value="{{$student->b_day}}">
                            
                        </div>
                        <div class="form-group col-md-6 col-12">
                          <label>Mobile</label>
                          <input type="text" class="form-control" name="mobile" value="0{{$student->mobile}}">
                          
                        </div>
                        <div class="form-group col-md-6 col-12">
                          <label>Barcode</label>
                          <input type="text" class="form-control" name="barcode" value="{{$student->barcode}}">
                          
                        </div>
                        <div class="form-group col-md-6 col-12">
                          <label class="form-label">Is A Student of Sadhana?</label>
                          <div class="selectgroup w-100">
                            <label class="selectgroup-item">
                              <input type="radio" name="is_sadhana" value="1" class="selectgroup-input-radio"
                              @if ($student->is_sadhana==1)
                              checked
                              @endif
                              >
                            ...
                            <label class="selectgroup-item">
                              <input type="radio" name="is_sadhana" value="0" class="selectgroup-input-radio" 
                              @if ($student->is_sadhana==0)
                              checked
                              @endif
                              >
                        ...
                        <div class="form-group col-md-6 col-12">
                          <label>Sadhana ID</label>
                          <input type="text" class="form-control" name="sadhana_reg_number" value="{{$student->sadhana_reg_number}}">
                      ...
                      <div class="row">
                        <div class="form-group col-md-6 col-12">
                            <label>Contact</label>
                            <textarea
                              class="form-control summernote-simple" name="contact">{{$student->contact}}</textarea>
                          </div>
                        <div class="form-group col-md-6 col-12">
                          <label>Address</label>
                          <textarea
                            class="form-control summernote-simple" name="address">{{$student->address}}</textarea>
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-6 col-12">
              ...
              <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="profile-tab2">
               <form method="POST" action="{{ route('admin_teachers_password',$student->id) }}">
                  @csrf
                  @method('PUT')
