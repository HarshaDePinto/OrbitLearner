                    ...
                    @foreach (session('search_users') as $teacher)
                        <div class="col-12 col-sm-12 col-lg-6">
                            ...
                            <div class="card-footer text-center pt-0">
                                ...
                                <a href="{{route('admin_teacher_groups',$teacher->id)}}" class="btn btn-info">All Classes</a>
                            </div>
                            </div>
            ...
            <table class="table table-striped" id="sortable-table">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{route('admin_teacher_groups',$teacher->id)}}" class="btn btn-info">Courses</a></td>
                    <td><a href="{{route('admin_teacher_clz',$teacher->id)}}" class="btn  btn-success">Classes</a></td>
