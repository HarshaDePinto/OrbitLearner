            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="page-title">{{$sub->title}} Teachers</h1>
                        <ul>
                            <li>
                                <a class="active" href="{{route('teachers')}}">Teachers</a>
                            </li>
                            <li>{{$sub->title}} Teachers</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row mb-30">
                <div class="col-lg-9 col-md-12">
                    <div class="row">
                        @foreach ($sub->s_teachers as $st)
                        <div class="col-lg-4 col-md-6 col-xs-6">
                            <div class="team-item">
                                <div class="team-img">
                                    <a href="#"><img src="{{ asset('storage/app/'.$st->user->image) }}" alt="" /></a>
                                ...
                                <div class="team-body">
                                    <a href="{{route('teacher_single',$st->user->id)}}"><h3 class="name">{{$st->user->title}} {{$st->user->f_name}} {{$st->user->l_name}}</h3></a>
                                    <span class="designation">{!!$st->user->des!!}</span>
                                </div>
                            </div>						
                        </div>
                        @endforeach
