...
function websdkready() {
  ...
  var API_KEY = "LY0wBYuCSx6NyZlxDUkSXw";
   ...
   */
  var API_SECRET = "eZlmEilsyinzmVKVsZTzbJhxoHgm78Mcnk42";
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "https://www.orbitlearner.com/";
  });
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      var meetingConfig = testTool.getMeetingConfig();
       ...
       meetingConfig.pwd= document.getElementById('meeting_pwd').value;    
       
       //alert(meetingConfig.mn);
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "https://www.orbitlearner.com/zoommeeting?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "https://www.orbitlearner.com/zoommeeting?" +
