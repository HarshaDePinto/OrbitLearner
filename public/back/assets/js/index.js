...
function websdkready() {
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "http://localhost/zoom/index.html";
  });
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "http://localhost/sadana-app/student-zoom?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "http://localhost/sadana-app/student-zoom?" +
